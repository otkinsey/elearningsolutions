										...
										<table class="twelve columns">
											<tr>
												<td>
													...
													<p>
														<?php printf( __( 'Thank you for your reservation at %s. Should you have any further information, please do not hesitate to contact us at any time.', 'solidres'), apply_filters( 'solidres_asset_name', $display_data['asset']->name ) ) ?>
													</p>
										...
										<table class="six columns">
											<tr>
												<td class="last right-text-pad">
													...
													<p>
														<?php
															echo __( 'Address: ', 'solidres' ) . $display_data['asset']->address_1 . ', ' . $display_data['asset']->postcode . ', ' . $display_data['asset']->city
														?>
													</p>
