...
class TP_Hotel_Booking{
    ...
    function load_text_domain(){
        ...
        $mofile = $global_old_file = WP_LANG_DIR . '/plugins/tp-hotel-booking-' . $locale . '.mo';
        $plugin_old_file = $dir . '/tp-hotel-booking-' . $locale . '.mo';

        if ( ! file_exists( $mofile ) && file_exists( $plugin_old_file ) ) {
            $mofile = $plugin_old_file;
        } else if ( ! file_exists( $mofile ) && file_exists( $globalFile ) ) {
            $mofile = $globalFile;
    ...
    function enqueue_assets(){
        ...
        if( is_admin() ){
            ...
            wp_register_style( 'wp-hotel-booking', $this->plugin_url( 'includes/assets/css/hotel-booking.min.css' ) );
            wp_register_script( 'wp-hotel-booking', $this->plugin_url( 'includes/assets/js/hotel-booking.min.js' ), $dependencies );
            ...
            wp_localize_script( 'wp-hotel-booking', 'hotel_booking_l18n', hb_l18n() );
