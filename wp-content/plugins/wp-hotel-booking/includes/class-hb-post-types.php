...
class HB_Post_Types{
        ...
        switch( $column ){
            case 'type':
                switch( get_post_meta( $post->ID, '_hb_coupon_discount_type', true ) ){
                    case 'fixed_cart': _e( 'Fixed cart', 'wp-hotel-booking' ); break;
                    case 'percent_cart': _e( 'Percent cart', 'wp-hotel-booking' ); break;
                }
                break;
            case 'from':
            case 'to':
    ...
    function register_post_types(){
        ...
        $args = array(
            'labels'             => array(
                'name'               => _x( 'Rooms', 'Rooms', 'wp-hotel-booking' ),
                'singular_name'      => _x( 'Room', 'Room', 'wp-hotel-booking' ),
        ...
        $args = array(
                ...
                'labels' => array(
                    'name'              => __( 'Room Types', 'wp-hotel-booking' ),
                    'singular_name'     => __( 'Room Type', 'wp-hotel-booking' ),
                    'menu_name'         => _x( 'Types', 'Room Types', 'wp-hotel-booking' ),
        ...
        $args = array(
                ...
                'labels' => array(
                    ...
                    'menu_name'         => _x( 'Types', 'Room Capacities', 'wp-hotel-booking' ),
        ...
        $args = array(
            'labels'             => array(
                'name'               => _x( 'Bookings', 'Bookings', 'wp-hotel-booking' ),
                'singular_name'      => _x( 'Booking', 'Booking', 'wp-hotel-booking' ),
        ...
        $args = array(
            'labels'             => array(
                'name'               => _x( 'Customers', 'Customers', 'wp-hotel-booking' ),
                'singular_name'      => _x( 'Customer', 'Customer', 'wp-hotel-booking' ),
                'menu_name'          => __( 'Customers', 'wp-hotel-booking' ),
                'parent_item_colon'  => __( 'Parent Item:', 'wp-hotel-booking' ),
                'all_items'          => __( 'Customers', 'wp-hotel-booking' ),
                'view_item'          => __( 'View Customer', 'wp-hotel-booking' ),
                'add_new_item'       => __( 'Add New Customer', 'wp-hotel-booking' ),
                'add_new'            => __( 'Add New', 'wp-hotel-booking' ),
                'edit_item'          => __( 'Edit Customer', 'wp-hotel-booking' ),
                'update_item'        => __( 'Update Customer', 'wp-hotel-booking' ),
                'search_items'       => __( 'Search Customer', 'wp-hotel-booking' ),
                'not_found'          => __( 'No customer found', 'wp-hotel-booking' ),
                'not_found_in_trash' => __( 'No customer found in Trash', 'wp-hotel-booking' ),
            ),
            'public'             => false,
            'query_var'          => true,
            'publicly_queryable' => false,
    ...
    function register_post_statues(){
        $args = array(
            'label'                     => _x( 'Pending Payment', 'Booking status', 'wp-hotel-booking' ),
            'public'                    => false,
            'exclude_from_search'       => false,
            'show_in_admin_all_list'    => true,
            'show_in_admin_status_list' => true,
            'label_count'               => _n_noop( 'Pending Payment <span class="count">(%s)</span>', 'Pending Payment <span class="count">(%s)</span>', 'wp-hotel-booking' )
        );
