...
<div class="wrap" id="tp_hotel_booking_pricing">
    ...
    <form method="post" name="pricing-table-form">
        <p><strong><?php _e( 'Select name of room', 'wp-hotel-booking' ); ?></strong>&nbsp;&nbsp;<?php echo hb_dropdown_rooms( array('selected' => $room_id) ); //$room_type_select; ?></p>
        <?php if( $room_id ){?>
            ...
            <div class="hb-pricing-list">
                <table>
                    ...
                    <tbody>
                        ...
                        <?php else:?>
                        <tr><td colspan="7"><?php _e( 'No capacities found', 'wp-hotel-booking' ); ?></td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
