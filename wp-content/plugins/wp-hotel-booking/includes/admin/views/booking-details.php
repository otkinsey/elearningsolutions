...
?>
<div class="wrap">
    <h2><?php _e( 'Booking Details: ','wp-hotel-booking' ); echo sprintf( '%s', hb_format_order_number( $booking_id ) );  ?></h2>
<?php
    $booking = HB_Booking::instance( $booking_id );
    if( ! $booking->post->ID ){
        _e( 'Invalid booking', 'wp-hotel-booking' );
        return;
    }
...
?>
    ...
    <table class="booking-details hb-booking-table">
        ...
        <thead>
            <th colspan="4">
                <h3><?php _e( 'Room Name', 'wp-hotel-booking') ?></h3>
            </th>
            <th colspan="4">
    ...
    <table class="hb-booking-rooms">
        <thead>
            <tr>
                <th colspan="5">
                    <h3><?php _e( 'Room Details', 'wp-hotel-booking') ?></h3>
                </th>
            </tr>
            <tr>
                <th align="left"><?php _e( 'Name', 'wp-hotel-booking' ); ?></th>
                <th align="left"><?php _e( 'Type', 'wp-hotel-booking' ); ?></th>
                <th align="left"><?php _e( 'Extra Package', 'wp-hotel-booking' ); ?></th>
                <th align="right"><?php _e( 'Quantity', 'wp-hotel-booking' ); ?></th>
                <th align="right"><?php _e( 'Sub total', 'wp-hotel-booking' ); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php $booking_rooms_params = get_post_meta( $booking_id, '_hb_booking_params', true ); ?>
        ...
        <?php if( $coupon = get_post_meta( $booking_id, '_hb_coupon', true ) ){ ?>
            <tr>
                <th colspan="4" align="left"><?php printf( __( 'Coupon Applied (%s)', 'wp-hotel-booking' ), $coupon['code'] ); ?></th>
                <td align="right" class="negative-price">-<?php echo hb_format_price( $coupon['value'], $currency_symbol ); ?></td>
            </tr>
        <?php } ?>
            <tr>
                <th colspan="4" align="left"><?php _e( 'Sub Total', 'wp-hotel-booking' ); ?></th>
                <td align="right"><?php echo hb_format_price( get_post_meta( $booking_id, '_hb_sub_total', true ), $currency_symbol ); ?></td>
            </tr>
            <tr>
                <th colspan="4" align="left"><?php _e( 'Price including tax', 'wp-hotel-booking' ); ?></th>
                <td align="right"><?php echo get_post_meta( $booking_id, '_hb_price_including_tax', true ) == 'yes' ? __( 'Yes', 'wp-hotel-booking') : __( 'No', 'wp-hotel-booking'); ?></td>
            </tr>
            <tr>
                <th colspan="4" align="left"><?php _e( 'Tax', 'wp-hotel-booking' ); ?></th>
                <td align="right">
                    <?php
                        $html = '';
            ...
            <tr>
                <th colspan="4" align="left"><?php _e( 'Default Currency', 'wp-hotel-booking' ); ?></th>
                <td align="right"><?php echo sprintf( '%s', $default_currency ); ?></td>
            </tr>
            <tr>
                <th colspan="4" align="left"><?php _e( 'Payment Currency', 'wp-hotel-booking' ); ?></th>
                <td align="right"><?php echo sprintf( '%s', $payment_currency ); ?></td>
            </tr>
            <tr>
                <th colspan="4" align="left">
                    <?php _e( 'Currency Rate', 'wp-hotel-booking' ); ?>
                    <?php printf( '%s / %s', $default_currency, $payment_currency ) ?>
                </th>
                <td align="right"><?php printf( '%s', $rate ); ?></td>
            </tr>
            <tr>
                <th colspan="4" align="left"><?php _e( 'Total', 'wp-hotel-booking' ); ?></th>
                <td align="right">
    ...
    <table class="hb-booking-table">
        <thead>
            <tr>
                <td colspan="2">
                    <h3><?php _e( 'Payment Details', 'wp-hotel-booking') ?></h3>
                </td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <th>
                    <?php _e( 'Payment Gateway', 'wp-hotel-booking' ); ?>
                </th>
                <td>
            ...
            <tr>
                <th>
                    <?php _e( 'Booking status', 'wp-hotel-booking' ); ?>
                </th>
                <td>
    ...
    <table class="hb-booking-table">
        ...
        <tr>
            <td colspan="2">
                <h3><?php _e( 'Addition Information', 'wp-hotel-booking') ?></h3>
            </td>
        </tr>
        </thead>
        <tbody>
