...
<table class="form-table">
    ...
    <tr>
        <th><?php _e( 'Test Mode Enable', 'wp-hotel-booking' ); ?></th>
        <td>
    ...
    <tr>
        <th><?php _e( 'Live Publishable Key', 'wp-hotel-booking' ); ?></th>
        <td>
