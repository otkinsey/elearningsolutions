<?php
	...
	$report_tabs = apply_filters( 'tp_hotel_booking_report_tab', array(
		array(
				'id'		=> 'price',
				'title'		=> __( 'Booking Price', 'wp-hotel-booking' ),
			),
		array(
				'id'		=> 'room',
				'title'		=> __( 'Room availability', 'wp-hotel-booking' ),
			)
	));
...
<?php
	$date = apply_filters( 'tp_hotel_booking_report_date', array(
		array(
				'id'	=> 'year',
				'title'	=> __('Year', 'wp-hotel-booking')
			),
		array(
				'id'	=> 'last_month',
				'title'	=> __('Last Month', 'wp-hotel-booking')
			),
		array(
				'id'	=> 'current_month',
				'title'	=> __('This Month', 'wp-hotel-booking')
			),
		array(
				'id'	=> '7day',
				'title'	=> __('Last 7 Days', 'wp-hotel-booking')
			)
	));
...
<div id="tp-hotel-booking-report" class="postbox">
	...
	<div id="poststuff">
		<h3>
			<!-- <a href="<?php //echo admin_url( 'admin.php?page=tp_hotel_booking_report&action=export' ) ?>" class="export_csv"><?php //_e( 'Export CSV', 'wp-hotel-booking' ) ?></a> -->
			<!--export-->
			<form id="tp-hotel-booking-export" method="POST">
				...
				<button type="submit"><?php _e( 'Export', 'wp-hotel-booking' ) ?></button>
			</form>
			<ul>
				...
				<li>
					<form method="GET">
						...
						<button type="submit"><?php _e( 'Go', 'wp-hotel-booking' ) ?></button>
					</form>
				</li>
			</ul>
		</h3>
