...
function hb_admin_settings_tabs(){
    $tabs = array(
        'general'       => __( 'General', 'wp-hotel-booking' ),
        'hotel_info'    => __( 'Hotel Information', 'wp-hotel-booking' ),
        'payments'      => __( 'Payments', 'wp-hotel-booking' ),
        'emails'        => __( 'Emails', 'wp-hotel-booking' ),
        'lightbox'      => __( 'Lightbox', 'wp-hotel-booking' ),
        'room'          => __( 'Room', 'wp-hotel-booking' )
    );
...
function hb_bookings_meta_boxes() {
    HB_Meta_Box::instance(
        'booking_info',
        array(
            'title'             => __('Booking Info','wp-hotel-booking'),
        ...
        array(
            'name'  => 'customer_id',
            'label' => __('Customer ID', 'wp-hotel-booking'),
            'type'  => 'label',
            'std'   => '',
        ...
        array(
            ...
            'label' => __('Price Including Tax', 'wp-hotel-booking'),
            'type'  => 'label',
            'std'   => '0',
            'attr'  => 'readonly="readonly"',
        ...
        array(
            'name'  => 'sub_total',
            'label' => __('Sub Total', 'wp-hotel-booking'),
            'type'  => 'label',
            'std'   => '',
            'attr'  => 'readonly="readonly"',
        ...
        array(
            'name'  => 'total',
            'label' => __('Total', 'wp-hotel-booking'),
            'type'  => 'label',
            'std'   => '0',
            'attr'  => 'readonly="readonly"',
...
function hb_customer_meta_box() {
    HB_Meta_Box::instance(
        'customer_info',
        array(
            'title'             => __('Customer Info','wp-hotel-booking'),
        ...
        array(
            'name'      => 'title',
            'label'     => __('Title', 'wp-hotel-booking'),
            'type'      => 'select',
            'options'   => apply_filters( 'hb_customer_titles', array(
                            array(
                                'value' => 'mr',
                                'text'    => __( 'Mr.', 'wp-hotel-booking' )
                            ),
                            array(
                                'value' => 'ms',
                                'text'    => __( 'Ms.', 'wp-hotel-booking' )
                            ),
                            array(
                                'value' => 'mrs',
                                'text'    => __( 'Mrs.', 'wp-hotel-booking' )
                            ),
                            array(
                                'value' => 'miss',
                                'text'    => __( 'Miss.', 'wp-hotel-booking' )
                            ),
                            array(
                                'value' => 'dr',
                                'text'    => __( 'Dr.', 'wp-hotel-booking' )
                            ),
                            array(
                                'value' => 'prof',
                                'text'    => __( 'Prof.', 'wp-hotel-booking' )
                            )
                        )
                    )
        ),
        array(
            'name'  => 'first_name',
            'label' => __('First Name', 'wp-hotel-booking'),
            'type'  => 'text'
        ),
        array(
            'name'  => 'last_name',
            'label' => __('Last Name', 'wp-hotel-booking'),
            'type'  => 'text'
        ),
        array(
            'name'  => 'address',
            'label' => __('Address', 'wp-hotel-booking'),
            'type'  => 'text'
        ),
        array(
            'name'  => 'city',
            'label' => __('City', 'wp-hotel-booking'),
            'type'  => 'text'
        ),
        array(
            'name'  => 'state',
            'label' => __('State', 'wp-hotel-booking'),
            'type'  => 'text'
        ),
        array(
            'name'  => 'postal_code',
            'label' => __('Postal Code', 'wp-hotel-booking'),
            'type'  => 'text'
        ),
        array(
            'name'  => 'country',
            'label' => __('Country', 'wp-hotel-booking'),
            'type'  => 'country',
        ),
        array(
            'name'  => 'phone',
            'label' => __('Phone', 'wp-hotel-booking'),
            'type'  => 'text'
        ),
        array(
            'name'  => 'email',
            'label' => __('Email', 'wp-hotel-booking'),
            'type'  => 'text',
            'attr'  => 'readonly="readonly"'
        ),
        array(
            'name'  => 'fax',
            'label' => __('Fax', 'wp-hotel-booking'),
            'type'  => 'text'
        )
    );
}
...
function hb_booking_table_head( $default ) {
    ...
    unset($default['date']);
    $default['customer_name']   = __( 'Customer Name', 'wp-hotel-booking' );
    $default['booking_date']    = __( 'Booking Date', 'wp-hotel-booking' );
    ...
    $default['title']           = __( 'ID', 'wp-hotel-booking' );
    $default['details']         = __( 'View Details', 'wp-hotel-booking' );
    return $default;
}
...
function hb_manage_booking_column( $column_name, $post_id ) {
    ...
    switch ( $column_name ){
        ...
        case 'check_out_date':
            ...
            break;
        case 'details':
            $echo[] = '<a href="'. admin_url('admin.php?page=hb_booking_details&id='. $post_id) . '">' . __( 'View', 'wp-hotel-booking' ) . '</a><br />';
...
function hb_customer_posts_columns( $default ) {
    unset($default['author']);
    unset($default['date']);
    $default['customer_address']    = __( 'Address', 'wp-hotel-booking' );
    $default['phone_number']        = __( 'Phone Number', 'wp-hotel-booking' );
    $default['email']               = __( 'Email', 'wp-hotel-booking' );
    $default['bookings']            = __( 'Bookings', 'wp-hotel-booking' );
    $default['title']               = __( 'Cus. Name', 'wp-hotel-booking' );
    return $default;
}
    ...
    switch ( $column_name ){
        ...
        case 'bookings':
            printf(
                ...
                get_admin_url(),
                $post_id,
                __( 'View Booking', 'wp-hotel-booking' )
            );
    }
}
...
function hb_meta_box_field_price_including_tax( $value ){
    return $value == 'yes' ? __( 'Yes', 'wp-hotel-booking' ) : __( 'No', 'wp-hotel-booking' ) ;
}
