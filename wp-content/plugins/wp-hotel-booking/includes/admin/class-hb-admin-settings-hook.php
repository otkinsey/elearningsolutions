	...
	public function create_pages( $name, $value ) {
		...
		if( $name == 'my-rooms' && $value == 1 )
		{
			$pages['my-rooms'] = array(
				'name'    => _x( 'my-rooms', 'Page slug', 'wp-hotel-booking' ),
				'title'   => _x( 'My Rooms', 'Page title', 'wp-hotel-booking' ),
		...
		if( $name === 'checkout' && $value == 1 )
		{
			$pages['checkout'] = array(
				'name'    => _x( 'room-checkout', 'Page slug', 'wp-hotel-booking' ),
				'title'   => _x( 'Checkout', 'Page title', 'wp-hotel-booking' ),
