...
if( ! hb_get_page_id( 'my-rooms' ) || ! get_post( hb_get_page_id( 'my-rooms' ) ) )
{
    $pages['my-rooms'] = array(
        'name'    => _x( 'my-rooms', 'my-rooms', 'wp-hotel-booking' ),
        'title'   => _x( 'My Rooms', 'My Rooms', 'wp-hotel-booking' ),
...
if( ! hb_get_page_id( 'checkout' ) || ! get_post( hb_get_page_id( 'checkout' ) ) )
{
    $pages['checkout'] = array(
        'name'    => _x( 'room-checkout', 'room-checkout', 'wp-hotel-booking' ),
        'title'   => _x( 'Checkout', 'Checkout', 'wp-hotel-booking' ),
...
{
    $pages['search'] = array(
        'name'    => _x( 'hotel-booking', 'hotel-booking', 'wp-hotel-booking' ),
        'title'   => _x( 'Hotel Booking', 'Hotel Booking', 'wp-hotel-booking' ),
...
{
    $pages['terms'] = array(
        'name'    => _x( 'term-condition', 'term-condition', 'wp-hotel-booking' ),
        'title'   => _x( 'Terms and Conditions ', 'Terms and Conditions', 'wp-hotel-booking' ),
